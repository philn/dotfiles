  ...
  (setq-default
   ...
   '(react
     ...
     (c-c++ :variables
            ...
            clang-format-executable "/home/linuxbrew/.linuxbrew/opt/clang-format/bin/clang-format"
...
It should only modify the values of Spacemacs settings."
  ...
  ;; spacemacs settings.
  (setq-default exec-path '("/home/phil/toolbox" "/home/phil/bin" "/home/phil/.cargo-home/bin" "/home/phil/.local/bin" "/bin" "/usr/bin" "/usr/sbin" "/app/bin")
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (customize-set-variable
   ...
   (concat
    "-o ControlPath=/home/phil/.ssh/sockets/%%r@%%h-%%p "
    "-o ControlMaster=auto -o ControlPersist=yes"))
  ;; (setq-default tramp-ssh-controlmaster-options '("-o ControlPath ~/.ssh/sockets/%r@%h-%p "))
...
before packages are loaded."
  ...
  ;;(flycheck-mode . nil) ;; flycheck interferes too much with autocompletion

	;;:clang (:pathMappings ("/app/webkit/>/var/home/phil/WebKit/")
  ;;        :extraArgs ("%h -x c++-header"))
  ...
  (dir-locals-set-directory-class
     "/var/home/phil/WebKit/" 'webkit-instance)
  (dir-locals-set-directory-class
   "/var/home/phil/gstreamer/" 'gst-instance)

  (remove-hook 'python-mode-hook 'spacemacs/init-eldoc-python-mode)

  ;; (setq history-length 0)
  (put 'minibuffer-history 'history-length 10)
  (put 'evil-ex-history 'history-length 10)
  (put 'kill-ring 'history-length 10)
  ;; (savehist-mode -1)
